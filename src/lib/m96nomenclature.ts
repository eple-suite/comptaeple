...
export const NOMENCLATURE_M96: CompteM96[] = [
  ...
  },
  {
    ...
    description: "Origine du financement des investissements (État, Région, Département, autres). Ces comptes représentent les ressources affectées à l'acquisition d'immobilisations.",
    interconnexions: ["21", "23", "28", "139"],
    estSubvention: true,
    sourceFinancement: "mixte",
    sphere: "comptable",
  ...
  },
  {
    ...
    description: "Subventions d'investissement versées par l'État pour financer des immobilisations",
  ...
  },
  {
    ...
    classe: 1, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions investissement",
    description: "Subventions d'investissement versées par les collectivités territoriales (Région/Département)",
  ...
  {
    numero: "134",
    libelle: "Subventions d'investissement — Autres organismes",
    classe: 1, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions investissement",
    description: "Subventions d'investissement reçues d'autres organismes (UE, associations, etc.). Origine du financement des immobilisations hors État/collectivités.",
    estSubvention: true, sourceFinancement: "mixte",
    interconnexions: ["21", "139"],
    sphere: "comptable",
  },
  {
    ...
    classe: 1, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions investissement",
    description: "Autres subventions d'investissement non classées ailleurs",
    estSubvention: true, sourceFinancement: "mixte",
    interconnexions: ["21", "139"],
    sphere: "comptable",
  },
  {
    numero: "139",
    libelle: "Subventions d'investissement inscrites au CdR",
    classe: 1, sensNormal: "debiteur", categorie: "bilan", sousCategorie: "Subventions investissement",
    description: "Quote-part des subventions d'investissement virée au compte de résultat (neutralisation). Ce compte vient en déduction du 13x.",
    interconnexions: ["131", "132", "134", "777"],
    sphere: "comptable",
  },
  {
    numero: "15",
  ...
  },
  {
    ...
    classe: 1, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Emprunts",
    description: "Emprunts contractés par l'EPLE (rare, soumis à autorisation)",
    sphere: "comptable",
    alerteSoldeAnormal: "⚠️ Un solde débiteur signifierait un remboursement excédentaire",
  },
  {
    numero: "181",
    libelle: "Comptes de liaison — Investissement",
    classe: 1, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Liaison investissement",
    description: "Comptes de liaison entre la sphère ordonnateur et comptable pour les opérations d'investissement. Traduit l'origine du financement des immobilisations dans Op@le.",
    interconnexions: ["21", "23", "13"],
    sphere: "les_deux",
    alerteSoldeAnormal: "⚠️ Ce compte doit s'équilibrer entre les deux sphères",
  },
  ...
  },
  {
    ...
    description: "Subventions de l'État à recevoir (sphère comptable). Crédit = notification/avance reçue, Débit = encaissement définitif.",
    interconnexions: ["7411", "5"],
    estSubvention: true,
    sourceFinancement: "etat",
    sphere: "comptable",
    alerteSoldeAnormal: "⚠️ Un solde débiteur important signifie des subventions d'État notifiées non encore encaissées",
  },
  {
    numero: "4411",
    libelle: "État — Subventions de fonctionnement",
    classe: 4, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions État",
    description: "Subventions de fonctionnement de l'État (sphère comptable). Ce compte enregistre les avances et versements de l'État.",
    estSubvention: true, sourceFinancement: "etat",
    interconnexions: ["7411", "5"],
    sphere: "comptable",
  },
  {
    numero: "4412",
    libelle: "Collectivités — Subventions de fonctionnement",
    classe: 4, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions collectivités",
    description: "Subventions de fonctionnement des collectivités territoriales (sphère comptable).",
    estSubvention: true, sourceFinancement: "collectivite",
    interconnexions: ["74121", "74122", "5"],
    sphere: "comptable",
  },
  {
    numero: "441220",
    libelle: "Dotation globale de fonctionnement — Collectivités",
    classe: 4, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions collectivités",
    description: "Dotation de fonctionnement versée par la collectivité de rattachement (Région pour lycées, Département pour collèges). Compte Op@le à 6 chiffres.",
    estSubvention: true, sourceFinancement: "collectivite",
    interconnexions: ["74122", "5"],
    sphere: "comptable",
    alerteSoldeAnormal: "⚠️ Solde débiteur = la dotation de fonctionnement n'a pas encore été encaissée par la collectivité",
  },
  {
    numero: "443",
    libelle: "État — Opérations particulières",
    classe: 4, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions État",
    description: "Opérations pour le compte de l'État : bourses nationales, aides sociales, primes. Sphère comptable.",
    interconnexions: ["7411", "5", "468100"],
    estSubvention: true,
    sourceFinancement: "etat",
    sphere: "comptable",
  },
  {
    ...
    description: "Enregistre au crédit les avances de bourses reçues de l'État (sphère comptable). Le débit est mouvementé via le 468100 pour imputation sur créances familles (4112/4113).",
    interconnexions: ["468100", "4112", "4113", "5"],
    estSubvention: true,
    sourceFinancement: "etat",
    sphere: "comptable",
  ...
  },
  {
    ...
    interconnexions: ["44311", "468100", "5"],
    sourceFinancement: "etat",
    sphere: "comptable",
  },
  {
    ...
    classe: 4, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Subventions État",
    description: "Primes versées par l'État (prime d'équipement, prime internat, etc.)",
    estSubvention: true, sourceFinancement: "etat",
    sphere: "comptable",
  },
  {
  ...
  {
    numero: "468100",
    libelle: "Produits à répartir — Bourses",
    classe: 4, sensNormal: "crediteur", categorie: "bilan", sousCategorie: "Régularisation bourses",
    description: "Compte pivot pour la répartition des bourses entre les créances familles (4112/4113) et le crédit bourses (44311). Permet de faire le lien entre l'avance État et l'imputation sur les frais scolaires.",
    interconnexions: ["44311", "44312", "4112", "4113"],
    sourceFinancement: "etat",
    sphere: "comptable",
    alerteSoldeAnormal: "⚠️ Ce compte doit être régulièrement apuré après chaque répartition de bourses",
  },
  {
    numero: "467",
  ...
  },
  {
    ...
    description: "Subventions de fonctionnement reçues (État, collectivités, autres). Sphère ordonnateur.",
    estSubvention: true,
    sourceFinancement: "mixte",
    interconnexions: ["441", "4412", "443"],
    sphere: "ordonnateur",
  },
  {
    numero: "741",
    ...
    classe: 7, sensNormal: "crediteur", categorie: "gestion", sousCategorie: "Subventions fonctionnement",
    description: "Subventions de fonctionnement des différents financeurs (sphère ordonnateur)",
    estSubvention: true, sourceFinancement: "mixte",
    sphere: "ordonnateur",
    imputationRecettes: true,
  },
  {
    numero: "7411",
    libelle: "Subventions État — Fonctionnement",
    classe: 7, sensNormal: "crediteur", categorie: "gestion", sousCategorie: "Subventions État",
    description: "Subventions de fonctionnement de l'État (sphère ordonnateur). Contrepartie du 4411 en sphère comptable.",
    estSubvention: true, sourceFinancement: "etat",
    interconnexions: ["4411", "443"],
    sphere: "ordonnateur",
    imputationRecettes: true,
  },
  {
    numero: "74121",
    libelle: "Subventions Région — Fonctionnement",
    classe: 7, sensNormal: "crediteur", categorie: "gestion", sousCategorie: "Subventions collectivités",
    description: "Subventions de fonctionnement de la Région (sphère ordonnateur). Pour les lycées.",
    estSubvention: true, sourceFinancement: "collectivite",
    interconnexions: ["4412", "441220"],
    sphere: "ordonnateur",
    imputationRecettes: true,
  },
  {
    numero: "74122",
    libelle: "Subventions Département — Fonctionnement",
    classe: 7, sensNormal: "crediteur", categorie: "gestion", sousCategorie: "Subventions collectivités",
    description: "Subventions de fonctionnement du Département (sphère ordonnateur). Pour les collèges.",
    estSubvention: true, sourceFinancement: "collectivite",
    interconnexions: ["4412", "441220"],
    sphere: "ordonnateur",
    imputationRecettes: true,
  ...
  {
    numero: "744",
    libelle: "Subventions — Autres organismes",
    classe: 7, sensNormal: "crediteur", categorie: "gestion", sousCategorie: "Subventions autres",
    description: "Subventions de fonctionnement d'autres organismes (UE, associations, etc.)",
    estSubvention: true, sourceFinancement: "mixte",
    sphere: "ordonnateur",
    imputationRecettes: true,
  },
  {
    numero: "777",
    libelle: "Quote-part des subventions d'investissement virée au CdR",
    classe: 7, sensNormal: "crediteur", categorie: "gestion", sousCategorie: "Neutralisation",
    description: "Produit exceptionnel correspondant à l'amortissement des subventions d'investissement (contrepartie du 139)",
    interconnexions: ["139", "13"],
    sphere: "ordonnateur",
  },
  {
    numero: "78",
