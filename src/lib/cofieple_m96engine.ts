...
export function calculerResultatsM96(
  ...
  return {
    ...
    sourceTauxCharges: sdeExec.realisedSourceKind,
    sourceTauxProduits: sdrExec.realisedSourceKind,
    sourceBudgetCharges: sdeExec.budgetSourceKind,
    sourceBudgetProduits: sdrExec.budgetSourceKind,
