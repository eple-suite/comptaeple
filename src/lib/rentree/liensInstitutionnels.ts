...
export const LIENS_INSTITUTIONNELS: LienInstitutionnel[] = [
  ...
  { id: "circ-passation", titre: "Note passation SGEPLE (DAF)", url: "https://www.education.gouv.fr/", categorie: "rh", description: "Procédure de passation entre SGEPLE entrant et sortant.", source: "DAF" },
