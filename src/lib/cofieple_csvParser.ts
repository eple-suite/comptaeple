...
export function parseSDE(text: string): LigneSDE[] {
  ...
  return rows.map(r => {
    ...
    return {
      ...
      compte,
      budget: toNum(r['budget'] || r['Budget'] || r['BUDGET'] || r['Prévisions'] || r['previsions'] || r['prévisions'] || r['Crédits ouverts'] || r['credits ouverts'] || r['Credits ouverts']),
...
export function parseSDR(text: string): LigneSDR[] {
  ...
  return rows.map(r => {
    ...
    return {
      ...
      activite: toStr(r['activités'] || r['activite'] || r['Activité'] || ''),
      compte,
      budget: toNum(r['budget'] || r['Budget'] || r['BUDGET'] || r['Prévisions'] || r['previsions'] || r['prévisions'] || r['Crédits ouverts'] || r['credits ouverts']),
      engage: toNum(r['engagé'] || r['engage'] || r['Engagé'] || r['Engage'] || r['ENGAGE']),
