...
export function parseSDE(text: string): LigneSDE[] {
  ...
  return rows.map(r => {
    ...
    return {
      ...
      compte,
      budget: toNum(r['budget'] || r['Budget'] || r['BUDGET'] || r['Prévisions'] || r['previsions'] || r['prévisions'] || r['Crédits ouverts'] || r['credits ouverts'] || r['Credits ouverts'] || r['Dotation'] || r['dotation'] || r['Crédits votés'] || r['Crédits initiaux'] || r['BI']),
      engage: toNum(r['engagé'] || r['engage'] || r['Engagé'] || r['Engage'] || r['ENGAGE']),
      realise: toNum(r['réalisé'] || r['realise'] || r['Réalisé'] || r['Realise'] || r['REALISE'] || r['mandaté'] || r['Mandaté'] || r['mandate'] || r['Mandate'] || r['MANDATE'] || r['liquidé'] || r['Liquidé']),
...
export function parseSDR(text: string): LigneSDR[] {
  ...
  return rows.map(r => {
    ...
    return {
      ...
      activite: toStr(r['activités'] || r['activite'] || r['Activité'] || ''),
      compte,
      budget: toNum(r['budget'] || r['Budget'] || r['BUDGET'] || r['Prévisions'] || r['previsions'] || r['prévisions'] || r['Crédits ouverts'] || r['credits ouverts'] || r['Dotation'] || r['dotation'] || r['Crédits votés'] || r['Crédits initiaux'] || r['BI']),
      engage: toNum(r['engagé'] || r['engage'] || r['Engagé'] || r['Engage'] || r['ENGAGE']),
      aor: toNum(r['aor'] || r['AOR'] || r['émis'] || r['Émis'] || r['emis'] || r['Emis'] || '0'),
      realise: toNum(r['réalisé'] || r['realise'] || r['Réalisé'] || r['Realise'] || r['REALISE'] || r['aor'] || r['AOR'] || r['émis'] || r['Émis'] || r['emis'] || r['Emis'] || r['titré'] || r['Titré'] || '0'),
