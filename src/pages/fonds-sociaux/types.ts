...
export const mockEleves: Eleve[] = [
  ...
  { id: "e2", nom: "BERNARD", prenom: "Emma", classe: "1ère STMG", regime: "interne", boursier: true, echelonBourse: 6, quotientFamilial: 180, situationFamiliale: "Parents séparés — père au RSA", responsableLegal: "M. BERNARD Pierre", telephone: "06 23 45 67 89", email: "p.bernard@email.fr" },
