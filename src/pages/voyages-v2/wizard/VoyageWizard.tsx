...
export function VoyageWizard({ open, onOpenChange, establishmentId, initial, onSaved }: Props) {
  ...
  const canNext = useMemo(() => validateStep(step, draft, recettes, depenses), [step, draft, recettes, depenses]);
        ...
        <div className="flex items-center justify-between pt-3 border-t">
          ...
          <div className="flex items-center gap-2">
            ...
            {step < STEPS.length ? (
              ...
              <Button onClick={handleFinish} disabled={saving} className="gradient-primary border-0">
