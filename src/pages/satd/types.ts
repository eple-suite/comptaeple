export interface TiersDetenteur {
  id: string;
  nom: string;
  type: "employeur" | "banque" | "caf" | "cpam" | "retraite" | "autre";
  adresse: string;
  codePostal: string;
  ville: string;
  siret: string;
...
export const mockTiers: TiersDetenteur[] = [
  { id: "t1", nom: "Rectorat d'Aix-Marseille — Service paie", type: "employeur", adresse: "Place Lucien Paye", codePostal: "13621", ville: "Aix-en-Provence", siret: "17130002700012", contact: "Service gestionnaire paie", email: "drh-paie@ac-aix-marseille.fr", telephone: "04 42 91 70 00" },
  { id: "t2", nom: "DDFiP des Bouches-du-Rhône", type: "autre", adresse: "16 rue Borde", codePostal: "13008", ville: "Marseille", siret: "", contact: "Service recouvrement", email: "", telephone: "04 91 17 80 00" },
  { id: "t3", nom: "Banque Postale", type: "banque", adresse: "115 rue de Sèvres", codePostal: "75275", ville: "Paris Cedex 06", siret: "42100000100014", contact: "Service saisies", email: "saisies@labanquepostale.fr", telephone: "" },
  { id: "t4", nom: "CAF des Bouches-du-Rhône", type: "caf", adresse: "29 boulevard de Dunkerque", codePostal: "13002", ville: "Marseille", siret: "", contact: "Service contentieux", email: "", telephone: "3230" },
  { id: "t5", nom: "Société XYZ — Employeur privé", type: "employeur", adresse: "Zone industrielle Les Paluds", codePostal: "13400", ville: "Aubagne", siret: "12345678900015", contact: "Service RH", email: "rh@xyz.fr", telephone: "04 42 00 00 00" },
];
