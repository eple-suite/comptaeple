// ═══════════════════════════════════════════════════════════════
// RAPPORT ORDONNATEUR — Composant dédié impression
...
function TitreSection({ texte }: { texte: string }) {
  return (
    <div style={{ background: '#003366', color: 'white', padding: '4px 10px', fontSize: '9.5pt', fontWeight: 'bold', marginTop: '10px', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.3px' }}>
      {texte}
    </div>
  );
}
...
function BlocCommentaire({ texte }: { texte: string }) {
  ...
  return (
    <div style={{ borderLeft: '3px solid #003366', padding: '6px 12px', background: '#f7f9fc', fontSize: '9pt', lineHeight: '1.5', whiteSpace: 'pre-wrap', marginTop: '6px', marginBottom: '8px' }}>
      {texte}
    </div>
  );
}
...
function GraphiqueBalance({ depenses, recettes }: { depenses: number; recettes: number }) {
  ...
  return (
    <div style={{ border: '1px solid #e0e0e0', borderRadius: '6px', padding: '12px 14px', background: 'white', pageBreakInside: 'avoid' }}>
  ...
  return (
    <div style={{ border: '1px solid #e0e0e0', borderRadius: '6px', padding: '12px 14px', background: 'white', pageBreakInside: 'avoid' }}>
          ...
          return (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', flex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'flex-end', gap: '2px', height: `${hauteurMax}px` }}>
                <div style={{ width: '12px', height: `${hB}px`, background: '#b3cde8', borderRadius: '2px 2px 0 0' }} />
                <div style={{ width: '12px', height: `${hR}px`, background: '#003366', borderRadius: '2px 2px 0 0' }} />
              </div>
              <div style={{ fontSize: '6pt', color: '#555', textAlign: 'center', marginTop: '2px', maxWidth: '55px', lineHeight: '1.1' }}>
      ...
      <div style={{ display: 'flex', gap: '14px', justifyContent: 'center', fontSize: '7pt', color: '#555' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '3px' }}><div style={{ width: '8px', height: '8px', background: '#b3cde8', borderRadius: '2px' }} /> Prévu</div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '3px' }}><div style={{ width: '8px', height: '8px', background: '#003366', borderRadius: '2px' }} /> Réalisé</div>
      </div>
    </div>
  );
}
...
export function RapportImpression() {
  ...
  return (
    <div id="rapport-impression-container" style={{ display: 'none', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '9pt', color: '#000', background: 'white' }}>
      ...
      <div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '6px', marginBottom: '10px' }}>
          {[
            ...
            <div key={i} style={{ border: '1px solid #ddd', borderRadius: '4px', padding: '6px 8px', background: 'white' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: '6px', marginBottom: '8px' }}>
          {[
            ...
            <div key={i} style={{ border: `1px solid ${kpi.couleur}`, borderRadius: '6px', padding: '6px 8px', background: 'white', pageBreakInside: 'avoid' }}>
      ...
      {(comments.resultat.trim() || comments.repartition.trim() || true) && (
      ...
      <div style={{ pageBreakBefore: 'always' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '6px', marginBottom: '6px' }}>
          {[
            ...
            <div key={i} style={{ border: '1px solid #ddd', borderRadius: '4px', padding: '5px 8px' }}>
